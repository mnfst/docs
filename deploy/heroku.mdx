---
title: "Deploy the LLM Gateway on Heroku"
sidebarTitle: "Heroku"
description: "Deploy the Manifest LLM Gateway with a container-stack web dyno and Heroku Postgres."
...
canonical: "https://manifest.build/llm-gateway/docs/deploy/heroku"
---

<Card
  title="Open Heroku deploy"
  icon="external-link"
  href="https://www.heroku.com/deploy?template=https://github.com/mnfst/llm-gateway"
>
