...
- Heroku's filesystem is ephemeral, which is why the deploy collects S3-compatible storage for [request logs](/llm-gateway/docs/request-logs) up front. Recordings live in your bucket, not on the dyno.
