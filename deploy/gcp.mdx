---
title: "Deploy the LLM Gateway on Google Cloud"
sidebarTitle: "GCP"
description: "Deploy the Manifest LLM Gateway with Cloud Run, Cloud SQL for PostgreSQL, Secret Manager, and Cloud Shell."
icon: "/icons/deploy/gcp.svg"
keywords:
  ["Manifest deployment", "GCP", "self-hosted gateway", "PostgreSQL", "Docker"]
