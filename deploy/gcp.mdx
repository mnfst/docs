...
The stack provisions a private Cloud Storage bucket and mounts it at `/data/request-recordings` for [request logs](/request-logs). The deploy prints its name as the `recording_bucket` output.
