...
- [Request logs](/request-logs) write to the Machine's local disk by default, which Fly replaces on each deploy. Attach a Fly Volume at `/data/request-recordings`, or point them at S3-compatible storage.
