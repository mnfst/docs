...
{/* TODO(Seb): screenshot — a request opened, Attempts list visible, Messages tab selected. Suggested path: /images/request-logs-drawer.png */}
...
{/* TODO(Seb): screenshot — the harness Settings page, Logs section with the Enable logs switch on. Suggested path: /images/request-logs-settings.png */}
