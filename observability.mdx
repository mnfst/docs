...
Configure a provider on the **Limits** page: Resend, Mailgun, or SendGrid. Enter the API key, domain, and notification address, then save. You can set the same thing with the [`EMAIL_*` environment variables](/reference/environment-variables).
