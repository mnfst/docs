...
That's all metadata. To read the messages themselves, turn on [message recording](/message-recording) for the harness. Open a request, pick an attempt, and its **Messages** tab shows the body sent to the provider and the body that came back.
