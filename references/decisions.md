...
- 2026-08-07 · INTERNAL-LEAK · deploy/aws,render,easypanel,koyeb · MANIFEST_MODE in guides but absent from the reference · status: accepted (documented as public) → PR #50 · https://github.com/mnfst/docs/issues/49 (finding 5)
