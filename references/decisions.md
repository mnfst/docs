...
- 2026-08-07 · OBSOLETE · introduction.mdx · card still says "Message recording" (+5 leftover mentions elsewhere) · status: raised · https://github.com/mnfst/docs/issues/49 (finding 1)
- 2026-08-07 · WRONG · self-hosted.mdx · "first account becomes the admin" vs the /setup wizard · status: raised · https://github.com/mnfst/docs/issues/49 (finding 2)
- 2026-08-07 · WRONG · self-hosted.mdx · "unknown model falls back to routing" vs M302 · status: raised · https://github.com/mnfst/docs/issues/49 (finding 3)
- 2026-08-07 · WRONG · self-hosted.mdx · fresh-install table gives M100 the definition of M101 · status: raised · https://github.com/mnfst/docs/issues/49 (finding 4)
- 2026-08-07 · INTERNAL-LEAK · deploy/aws,render,easypanel,koyeb · instance-mode env var in guides but absent from the reference (internal or public?) · status: raised · https://github.com/mnfst/docs/issues/49 (finding 5)
- 2026-08-07 · MISSING-CASE · introduction.mdx · free plan quota (10k/month) stated nowhere outside the M204 error page · status: raised · https://github.com/mnfst/docs/issues/49 (finding 6)
