...
- 2026-08-06 · MISSING-CASE · self-hosted.mdx + message-recording.mdx · pre-July installs need an upgrade step · status: accepted (custom: cloud/self-hosted toggle on the section; self-hosted side says logs were reintroduced in <version>, link to self-hosted Upgrading) · https://github.com/mnfst/docs/issues/45 (finding 4)
