...
- Every page exists twice: `<page>.mdx` at the repo root, published by
  Mintlify, and `llm-gateway/docs/<page>.mdx`, its dead twin. Edit both, or
  the change never reaches the site. The coherence check enforces it.
