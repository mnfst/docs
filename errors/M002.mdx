...
sidebarTitle: "M002"
description: "M002 is returned when the Bearer token is empty, often because an environment variable was not expanded."
icon: "key-round"
keywords:
...
canonical: "https://manifest.build/llm-gateway/docs/errors/M002"
---
...
See https://manifest.build/llm-gateway/docs/errors/M002
```
