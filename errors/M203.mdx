...
sidebarTitle: "M203"
description: "Manifest error M203 fires when a harness has more than 10 in-flight requests. Returns HTTP 429. Common with parallel streaming. Fix: reduce parallelism."
icon: "timer"
keywords:
...
Manifest caps in-flight requests per harness at 10. Streaming completions hold a slot until the stream ends, so an agent that fires off parallel streams can hit this fast.
