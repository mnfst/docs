...
Chat and streaming clients receive every code below as an HTTP 200 assistant message carrying the error text. The HTTP status codes named in each section apply to non-chat clients (SDKs and tools), except where a code states otherwise.
