...
The first time you enable Auto-fix, Manifest records a one-time consent for the install: you are agreeing that failing requests are sent to the hosted service. Any enable path records it, whether the Connect Harness toggle, a Settings toggle, or the enable-all API.
