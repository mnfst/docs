...
<Frame caption="The Autofix toggle in the Connect Harness modal, pre-set to on.">
  <img src="/images/autofix-connect-harness.png" alt="The Connect Harness modal with the Autofix toggle switched on under the name field" />
</Frame>
...
<Frame caption="The Autofix toggle on a harness's Settings page.">
  <img src="/images/autofix-settings-toggle.png" alt="A harness's Settings page with the Autofix failing requests toggle switched on" />
</Frame>

<Frame caption="The modal opened by the sidebar card, one toggle per harness.">
  <img src="/images/autofix-enable-modal.png" alt="The Enable Autofix modal listing harnesses that have Autofix off, each with its own toggle" />
</Frame>
...
- [Message recording](/request-logs): reading the original and patched bodies
- [Error codes](/errors)
