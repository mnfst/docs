...
<Note>
  Errors raised by The gateway itself carry an `M###` code, a plain-English cause, and a link to the matching page under [manifest.build/docs/errors](/llm-gateway/docs/errors). The three you are most likely to see on a fresh install:
