...
canonical: "https://manifest.build/llm-gateway/docs/providers/subscription-based-providers"
---
...
<Note>
  ...
  [fallback](/llm-gateway/docs/llm-gateway#fallback) model, usually a different provider on an API key.
</Note>
...
Pin your subscription model to your default or a custom tier and add API-key models to the [fallback list](/llm-gateway/docs/llm-gateway#configuration). Manifest handles the switch.
