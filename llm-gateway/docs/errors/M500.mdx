...
sidebarTitle: "M500"
description: "M500 is returned when the gateway encounters an unhandled internal error."
icon: "server-crash"
keywords:
...
canonical: "https://manifest.build/llm-gateway/docs/errors/M500"
---
...
- [Fallback](/llm-gateway/docs/llm-gateway#fallback)
