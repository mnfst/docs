...
sidebarTitle: "M102"
description: "Manifest error M102 fires when routing picks a subscription provider whose OAuth or refresh credentials cannot be used. Fix: reconnect the subscription from Providers → Subscriptions."
icon: "plug-zap"
keywords:
  [
    "M102",
...
- [M101: No providers configured](/llm-gateway/docs/errors/M101)
