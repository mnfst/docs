...
canonical: "https://manifest.build/llm-gateway/docs/deploy/koyeb"
---
...
- Koyeb instances have an ephemeral filesystem, which is why the deploy link collects S3-compatible storage for [request logs](/llm-gateway/docs/request-logs). Recordings live in your bucket, not on the instance.
