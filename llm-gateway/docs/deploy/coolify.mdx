---
title: "Deploy the LLM Gateway on Coolify"
sidebarTitle: "Coolify"
description: "Deploy the Manifest LLM Gateway with a Docker Compose service stack, generated secrets, and a private PostgreSQL container."
...
canonical: "https://manifest.build/llm-gateway/docs/deploy/coolify"
---

<Card
  title="View Coolify template"
  icon="external-link"
  href="https://github.com/mnfst/llm-gateway/tree/main/deploy/coolify"
>
