...
Railway is the fastest hosted path for Manifest. Use the published Manifest template to create a project with the Manifest app, a PostgreSQL database, and a storage bucket for [request logs](/llm-gateway/docs/request-logs), then open the generated domain and create the first admin account.
