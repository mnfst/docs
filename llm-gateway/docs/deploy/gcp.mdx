...
canonical: "https://manifest.build/llm-gateway/docs/deploy/gcp"
---
...
The stack provisions a private Cloud Storage bucket for [request logs](/llm-gateway/docs/request-logs). The deploy prints its name as the `recording_bucket` output.
