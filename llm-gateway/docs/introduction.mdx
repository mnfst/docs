---
title: "Manifest LLM Gateway documentation"
sidebarTitle: "Introduction"
description: "Connect models and subscriptions behind one OpenAI- and Anthropic-compatible endpoint, with routing, fallbacks, limits, and Autofix."
icon: "house"
keywords:
...
canonical: "https://manifest.build/llm-gateway/docs/introduction"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Self-hosting" icon="server" href="/llm-gateway/docs/deploy">
...
On Cloud there is nothing to install or configure on a server. You sign up, connect your providers, and point your harness at the gateway URL. Routing, limits, [Autofix](/llm-gateway/docs/autofix), and alerts are settings in the dashboard. The [environment variables](/llm-gateway/docs/reference/environment-variables) throughout these docs apply only to a self-hosted gateway.
...
<Frame caption="The guided setup after signing up: step one creates your first harness.">
  <img src="/images/welcome-setup.png" alt="The LLM Gateway guided setup on step one, Create your first harness, with the five setup steps listed in the sidebar" />
</Frame>
...
Install the gateway first. [Self-hosted](/llm-gateway/docs/self-hosted) covers Docker and the managed platforms. Your instance starts empty. [First request](/llm-gateway/docs/self-hosted#first-request) takes you from there to a routed request against `http://localhost:2099/v1`.
