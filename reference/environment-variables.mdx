...
| `HOST_BIND_ADDRESS` | `127.0.0.1` | Host interface the bundled compose file binds the dashboard port to. Set `0.0.0.0` to expose it on the LAN; survives `install.sh --upgrade`, unlike a hand-edit of `docker-compose.yml` |
