...
| `THROTTLE_LIMIT` | `100` | Max dashboard API calls per window. The gateway caps (200/min per workspace, 500/min per IP, 10 in flight) are fixed and not configurable |
