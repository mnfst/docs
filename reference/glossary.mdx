...
A routing lane with its own model and fallback chain. Every agent has a **Default** tier; you can add **Custom** tiers matched on request headers. See [Routing](/llm-gateway).
