---
title: "Glossary"
description: "Definitions for harness, tier, default and custom routing, direct routing, fallback chain, auto, and provider auth types."
icon: "book"
keywords:
  ["agent", "harness", "tier", "custom tier", "default routing", "direct routing", "fallback chain", "auto", "provider", "auth type"]
---
