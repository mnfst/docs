...
A connection keeps the model list it discovered at connection time. See [Refreshing the model list](/providers/api-key-providers#refreshing-the-model-list) when your plan gains or renames a model.
