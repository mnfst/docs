...
description: "Use supported subscriptions such as ChatGPT, Claude, Gemini, Grok, GitHub Copilot, GLM Coding Plan, Kimi, and Mistral Vibe."
icon: "credit-card"
keywords:
...
Pin your subscription model to your default or a custom tier and add API-key models to the [fallback list](/llm-gateway/docs/llm-gateway#configuration). The gateway handles the switch.
