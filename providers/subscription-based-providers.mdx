...
Pin your subscription model to your default or a custom tier and add API-key models to the [fallback list](/llm-gateway#configuration). The gateway handles the switch.
