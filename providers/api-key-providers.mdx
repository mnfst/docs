...
description: "Connect provider API keys for OpenAI, Anthropic, Google, xAI, DeepSeek, Mistral, Groq, Cerebras, AWS Bedrock, NVIDIA NIM, OpenRouter, Hugging Face, and more."
icon: "key"
keywords:
...
canonical: "https://manifest.build/llm-gateway/docs/providers/api-key-providers"
---
