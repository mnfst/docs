...
- [LLM Gateway](/llm-gateway) — what the gateway does with each request
- [Providers](/providers/api-key-providers) — connect subscriptions, API keys, and local models
- [API reference](/reference/api) — the endpoints the CLI calls
- [Telemetry](/reference/telemetry) — what the dashboard and CLI report
